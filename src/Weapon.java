...
//		Mace	2d4	
		this.strengthFromWeapons = 2 * dice.rollDie(4);
		break;
		
		
		case 2: this.name = "Long Sword";
//		Long sword	3d4	
		this.strengthFromWeapons = 3 * dice.rollDie(4);
		break;
		
		case 3: this.name = "Short Bow";
//		Short bow	1d1	
		this.strengthFromWeapons = 1; //1d1 damage 
		break;
		
		case 4: this.name = "Arrow";
//		Arrow	2d3	Takes bonuses from equipped short bow.
		this.strengthFromWeapons = 2 * dice.rollDie(3);
		break;
		
		case 5: this.name = "Dagger"; 
//		Dagger	1d6
		this.strengthFromWeapons = dice.rollDie(6); //1d6 damage  
		break;
...
//		Two handed sword	4d4	
		this.strengthFromWeapons = 4* dice.rollDie(4);
		break;
...
//		Dart	1d3 thrown	
		this.strengthFromWeapons = dice.rollDie(3);
		break;
