...
//		Mace	2d4	
		this.strengthFromWeapons += dice.roll(2, 4);
		break;
		
		
		case 2: this.name = "Long Sword";
//		Long sword	3d4	
		this.strengthFromWeapons += dice.roll(3, 4);
		break;
...
//		Arrow	2d3	Takes bonuses from equipped short bow.
		this.strengthFromWeapons += dice.roll(2, 3);
		break;
		
		case 5: this.name = "Dagger"; 
//		Dagger	1d6
		this.strengthFromWeapons += dice.roll(1,6);
		break;
...
//		Two handed sword	4d4	
		this.strengthFromWeapons += dice.roll(4,4);
		break;
...
//		Dart	1d3 thrown	
		this.strengthFromWeapons += dice.roll(1,3);
		break;
