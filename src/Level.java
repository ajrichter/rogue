...
public class Level {
	 ...
	 * 
	 * Need to fix isSeen
	 * if #/ first + then make all squares around @ seen
	 * if second + then make room seen
	 * if . then nothing
	 */
	public int moveUnit(Unit u, int[] dir) {
		...
		if (Character.isUpperCase(c)) {
			 ...
			 * At a minimum: all 8 surrounding squares are seen
			 * */
	...
	/*
	 * Pass a point
	 * If its a + then see the Rm
	 * If its not then see the 8(9-self) surrounding squares
	 */
